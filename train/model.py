'''
Short-chunk CNN with residual connections adapted from the work of Won et al.
See their paper for further discussion at https://ieeexplore.ieee.org/abstract/document/9053669
'''
import numpy as np
import torch
